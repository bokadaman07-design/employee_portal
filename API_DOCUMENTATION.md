...
Employee records carry an optional `phone`, an optional `country_code`
(max 10 chars, e.g. `"+1"`), and an optional `gender` (max 30 chars,
e.g. `"Female"`). All three are nullable and independent — omitting them
